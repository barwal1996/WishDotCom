...
<html lang="en">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="./uploadImagedemo">Product</a></li>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <a class="btn btn-light btn-xl js-scroll-trigger" href="uploadImagedemo">Get Started!</a>
                    </div>
                </div>
            </div>
        </section>
  ...
  text-align: center;
	                   ...
	                   <!-- --------------------------------------- -->
	             <c:url var="buyLaptop" value="productname">
								<c:param name="product" value="Laptop" />
	             ...
	             <div class="product-desc">
			          ...
			          <p>Get latest Samsung,MI,ACER Laptop</p>
			           <p><a class="btn btn-success btn-lg" href="${buyLaptop}" role="button">View Product List</a></p>
         ...
         <div class="col-lg-4">
	          ...
	          <img class="img-circle" src="<c:url value="/resources/static/images/mobile.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <!-- --------------------------------------- -->
	             <c:url var="buyMob" value="productname">
								<c:param name="product" value="Mobile" />
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="${buyMob}" role="button">View Product List</a></p>
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/camera.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <c:url var="buyCamera" value="productname">
								<c:param name="product" value="Camera" />
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="${buyCamera}" role="button">View Product List</a></p>
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/tv.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <!-- ------------------------------------ -->
	             <c:url var="buyTv" value="productname">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="${buyTv}" role="button" >View Product List</a></p>
         ...
         <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/refrigerator.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <c:url var="buyRefrigerator" value="productname">
								<c:param name="product" value="Refrigerator" />
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="${buyRefrigerator}" role="button" >View Product List</a></p>
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/tablet.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <c:url var="buyTablet" value="productname">
								<c:param name="product" value="Tablet" />
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="${buyTablet}" role="button" >View Product List</a></p>
        ...
        <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/micro%20oven.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/MicroOven/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
         ...
         <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/dvd.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/DvdPlayer/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/fan.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Fan/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
        ...
        <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/printer.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Printer/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
         ...
         <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/desktop.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Desktop/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/washing%20machines.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Washing Machine/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
        ...
        <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/ipad.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
	                  <h2>iPad</h2>
			          <p>Get  latest iPad </p>
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/ipad/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
         ...
         <div class="col-lg-4">
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/game%20consol.jpg"/>" alt="Generic placeholder image" width="140" height="140">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Game console/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
          ...
          <img class="img-circle" src="<c:url value="/resources/static/images/router.jpg"/>" alt="Generic placeholder image" width="190" height="190">
	             ...
	             <div class="product-desc">
			          ...
			          <p><a class="btn btn-success btn-lg" href="<c:url  value="/product/productList/Router/1"/>" role="button"onclick="if((confirm('Login First'))) return false">View Product List</a></p>
