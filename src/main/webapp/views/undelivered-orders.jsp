...
<body class="hold-transition sidebar-mini layout-fixed" background-color="#d7f7a3">
	...
	<aside class="main-sidebar sidebar-dark-primary elevation-4" style
			...
			<nav class="mt-2">
               ...
               with font-awesome or any other icon font library -->
					<li class="nav-item has-treeview menu-open"><a
						href="./adminHome" class="nav-link "> <i
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item active" href="undeliverdOrders">UnDelivered</a>
          </div>
      </li>
						</ul></li>
			</nav>
...
#product th {
  ...
  color: white;
    ...
    <table id="product" class="table table-info border="1" cellpadding="10">
        ...
        <tbody>
        <c:forEach items="${undelvrdprdcts}" var="orderlist">
...
<!-- construct an "update" link with customer id -->
							<c:url var="makeDeliver" value="makeDeliver">
								 <c:param name="deliverOrdId" value="${orderlist.orderId}" />
                ...
                <td scope="col">${orderlist.orderAmt}</td>
                 ...
                 <td scope="col">
                   	<!-- display the update link --> 
									<a class="btn btn-warning" href="${makeDeliver}" role ="button" onclick="if (!(confirm('Are you sure you want to mark this product as deliverd?'))) return false">Make It Deliver! </a>
								
								<p id="demo"></p>

<script>
function myFunction() {
  alert("Now order marked as delivered");
}
</script>
                </td>
